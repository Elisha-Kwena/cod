...
<div className="menu relative" ref={dropdownRef}>
    <button 
        ...
        <span className={clsx(
            ...
            {
            'text-sapphire': openDropdown === 'explore', // Sapphire when open
            'text-black dark:text-white dark:hover:text-sapphire hover:text-sapphire': openDropdown !== 'explore' // Normal/hover state
             }
            )}>
                Explore
            </span>
            <ChevronDownIcon className={clsx(
                  ...
                  {
                    'rotate-180 text-sapphire': openDropdown === 'explore', // Rotated up and sapphire when open
                    'text-black dark:text-white group-hover:text-sapphire': openDropdown !== 'explore' // Normal/hover state
                  }
                )}/>
              </button>

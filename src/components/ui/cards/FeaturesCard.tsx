...
const FeaturesCard: React.FC<FeatureProps> = ({ title,description,features,icon }) => {
    return (
        <div className="bg-dark800 p-6 border border-chrome/50 rounded-lg shadow-md flex flex-col items-center hover:shadow-lg hover:-translate-y-2 transition-all group duration-300 hover:border hover:border-electric">

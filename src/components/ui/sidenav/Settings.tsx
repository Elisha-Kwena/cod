    ...
    <>
        <div className="menu-item w-full">
            <Link 
                ...
                {'text-sapphire dark:text-sapphire bg-white dark:bg-dark800 p-1 rounded-md border border-electric shadow-[0_1px_2px_rgba(0,0,0,0.05),0_1px_3px_rgba(0,0,0,0.1)] dark:shadow-[0_1px_2px_rgba(0,0,0,0.2),0_1px_3px_rgba(0,0,0,0.3)]':pathname === '/settings'}
                    )}
                >
